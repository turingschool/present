  ...
  describe 'instance methods' do
    describe '#am_or_pm' do
      it 'should return am if time is before noon mountain' do
        attendance_1 = create(:attendance, meeting_time: DateTime.parse('2021-12-17T16:00:00Z')) # 9am mountain
        attendance_2 = create(:attendance, meeting_time: DateTime.parse('2021-12-17T17:00:00Z')) # 10am mountain
        attendance_3 = create(:attendance, meeting_time: DateTime.parse('2021-12-17T18:59:59Z')) # 11:59:59am mountain
      ...
      it 'should return pm if the time is noon mountain or later' do
        attendance_1 = create(:attendance, meeting_time: DateTime.parse('2021-12-17T20:00:00Z')) # 1pm mountain
        attendance_2 = create(:attendance, meeting_time: DateTime.parse('2021-12-17T19:00:00Z')) # 12:00pm mountain
    ...
    describe 'pretty_time' do
      it 'returns hours and minutes in mountain time' do
        attendance_1 = create(:attendance, meeting_time: DateTime.parse('2021-12-17T16:00:00Z')) # 9am mountain
        attendance_2 = create(:attendance, meeting_time: DateTime.parse('2021-12-17T20:00:00Z')) # 1pm mountain
        attendance_3 = create(:attendance, meeting_time: DateTime.parse('2021-12-17T18:59:59Z')) # 11:59:59am mountain
